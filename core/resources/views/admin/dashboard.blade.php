...
@section('panel')
    ...
    <div class="row mt-2 gy-4">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.organizers.all') }}" icon="las la-users" title="Total Organizers"
                value="{{ $widget['total_organizers'] }}" bg="primary" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.organizers.active') }}" icon="las la-user-check"
                title="Active Organizers" value="{{ $widget['verified_organizers'] }}" bg="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.organizers.email.unverified') }}" icon="lar la-envelope"
                title="Email Unverified Organizers" value="{{ $widget['email_unverified_organizers'] }}" bg="danger" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="6" link="{{ route('admin.organizers.mobile.unverified') }}" icon="las la-comment-slash"
                title="Mobile Unverified Organizers" value="{{ $widget['mobile_unverified_organizers'] }}"
                bg="warning" />
        </div>
    </div>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.order.index') }}" icon="lab la-dropbox" title="All Orders"
                value="{{ $orders['all_orders'] }}" bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.order.completed') }}" icon="las la-tasks"
                title="Completed Orders" value="{{ $orders['completed_orders'] }}" bg="1" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.order.cancelled') }}" icon="las la-times-circle"
                title="Cancelled Orders" value="{{ $orders['cancelled_orders'] }}" bg="14" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-sm-6">
            <x-widget style="3" link="{{ route('admin.order.refunded') }}" icon="las la-truck-loading"
                title="Refunded Orders" value="{{ $orders['refunded_orders'] }}" bg="19" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->

    <div class="row gy-4 mt-2">
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.event.index') }}" icon="las la-calendar-check"
                title="All Events" value="{{ $events['all_events'] }}" bg="primary" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.event.approved') }}" icon="las la-check-double"
                title="Approved Events" value="{{ $events['approved_events'] }}" bg="1" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.event.pending') }}" icon="las la-search-dollar"
                title="Pending Events" value="{{ $events['pending_events'] }}" bg="2" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.event.rejected') }}" icon="las la-times-circle"
                title="Rejected Events" value="{{ $events['rejected_events'] }}" bg="3" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.event.future.events') }}" icon="las la-binoculars"
                title="Future Events" value="{{ $events['futureEvents_events'] }}" bg="4" />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-2 col-lg-4 col-sm-6">
            <x-widget style="5" link="{{ route('admin.event.running') }}" icon="las la-running"
                title="Running Events" value="{{ $events['running_events'] }}" bg="5" />
        </div><!-- dashboard-w1 end -->
    </div><!-- row end-->
