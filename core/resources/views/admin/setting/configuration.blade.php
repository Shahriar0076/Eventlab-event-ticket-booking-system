                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li
                                ...
                                <div>
                                    <p class="fw-bold mb-0">@lang('Event Verification')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, organizer can add events and event will be approved automatically')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        ...
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="event_verification"
                                        @if (gs('event_verification')) checked @endif>
                                </div>
                            </li>
                            ...
                            <li
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, people can\'t register as user on this system')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                            ...
                            <li
                                class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Organizer Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, people can\'t register as organzier on this system')</small>
                                    </p>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        ...
                                        name="organizer_registration" @if (gs('organizer_registration')) checked @endif>
                                </div>
                            </li>
