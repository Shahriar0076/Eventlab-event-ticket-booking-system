                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="fw-bold">
                                ...
                                @else
                                    <a
                                        href="{{ route('admin.organizers.detail', $withdrawal->organizer_id) }}">{{ @$withdrawal->organizer->username }}</a>
                                @endif
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <div class="col-lg-8 col-md-8 mb-30">
            <div class="card  overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    @else
                        <h5 class="card-title border-bottom pb-2">@lang('Organizer Withdraw Information')</h5>
                    @endif
