        ...
        <div class="card-body">
            <div class="widget-card-inner">
                <div class="widget-card bg--success">
                    <a href="{{ url()->route('admin.withdraw.data.approved', request()->all()) }}"
                ...
                <div class="widget-card bg--warning">
                    <a href="{{ url()->route('admin.withdraw.data.pending', request()->all()) }}"
                        class="widget-card-link"></a>
                    <div class="widget-card-left">
                        <div class="widget-card-icon">
                ...
                <div class="widget-card bg--danger">
                    <a href="{{ url()->route('admin.withdraw.data.rejected', request()->all()) }}"
                        class="widget-card-link"></a>
                    <div class="widget-card-left">
                        <div class="widget-card-icon">
