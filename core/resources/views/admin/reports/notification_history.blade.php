                                            ...
                                            @if ($log->user || $log->organizer)
                                                @if ($log->user)
                                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                        ...
                                                        @if ($log->notification_type == 'email') data-message="{{ route('admin.report.user.email.details', $log->id) }}" @else data-message="{{ $log->message }}" @endif
                                                ...
                                                @else
                                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                                        data-type="{{ $log->notification_type }}"
                                                        @if ($log->notification_type == 'email') data-message="{{ route('admin.report.organizer.email.details', $log->id) }}" @else data-message="{{ $log->message }}" @endif
                                                        @if (@$log->image) data-image="{{ asset(getFilePath('push') . '/' . @$log->image) }}" @endif
                                                        data-sent_to="{{ $log->sent_to }}"><i class="las la-desktop"></i>
                                                        @lang('Detail')</button>
                                                @endif
