...
@section('content')
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <form action="{{ route('organizer.withdraw.money') }}" method="post" class="withdraw-form">
                @csrf
                <div class="gateway-card dashboard-table">
                    ...
                    <div class="row justify-content-center gy-sm-4 gy-3">
                                ...
                                @foreach ($withdrawMethod as $data)
                                    <label for="{{ titleToKey($data->name) }}"
                                        ...
                                        <input class="payment-item__radio gateway-input" id="{{ titleToKey($data->name) }}"
                                            hidden data-gateway='@json($data)' type="radio"
                        ...
                        <div class="col-lg-6">
                            <div class="payment-system-list p-3">
                                ...
                                <div class="deposit-info">
                                    <div class="deposit-info__title">
                                        <p class="text has-icon mb-2">@lang('Processing Charge')
