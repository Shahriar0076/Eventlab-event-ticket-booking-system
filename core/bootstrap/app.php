...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'organizer.check' => \App\Http\Middleware\OrganizerCheck::class,
            'organizer.registration.complete' => \App\Http\Middleware\OrganizerRegistrationStep::class,
            'organizer.guest' => \App\Http\Middleware\RedirectIfOrganizer::class,
        ]);
