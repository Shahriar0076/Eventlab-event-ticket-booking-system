...
class DepositController extends Controller
{
    ...
    {
        $deposit = Deposit::where('id', $id)->deposits()->with(['user', 'gateway'])->firstOrFail();
    ...
    {
        $deposit = Deposit::where('id', $id)->deposits()->where('status', Status::PAYMENT_PENDING)->firstOrFail();
    ...
    public function reject(Request $request)
    {
        ...
        $deposit = Deposit::where('id', $request->id)->deposits()->where('status', Status::PAYMENT_PENDING)->firstOrFail();
