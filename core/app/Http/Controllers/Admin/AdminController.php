...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Organizer Info
        $widget['total_organizers']             = Organizer::count();
        $widget['verified_organizers']          = Organizer::active()->count();
        $widget['email_unverified_organizers']  = Organizer::emailUnverified()->count();
        $widget['mobile_unverified_organizers'] = Organizer::mobileUnverified()->count();
        ...
        $deposit['total_deposit_amount']        = Deposit::successful()->deposits()->sum('amount');
        $deposit['total_deposit_pending']       = Deposit::pending()->deposits()->count();
        $deposit['total_deposit_rejected']      = Deposit::rejected()->deposits()->count();
        $deposit['total_deposit_charge']        = Deposit::successful()->deposits()->sum('charge');
        ...
        //Events
        $events['all_events'] = Event::count();
        $events['approved_events'] = Event::approved()->count();
        $events['pending_events'] = Event::pending()->count();
        $events['rejected_events'] = Event::rejected()->count();
        $events['futureEvents_events'] = Event::futureEvents()->count();
        $events['running_events'] = Event::running()->count();

        //Orders
        $orders['all_orders'] = Order::count();
        $orders['completed_orders'] = Order::completed()->count();
        $orders['cancelled_orders'] = Order::cancelled()->count();
        $orders['refunded_orders'] = Order::refunded()->count();

        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'withdrawals', 'events', 'orders'));
    }
