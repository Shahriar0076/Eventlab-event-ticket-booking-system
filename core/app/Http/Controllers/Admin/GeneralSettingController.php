...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'payment_timeout' => 'required|integer',
            'max_gallery_images' => 'required|integer|gt:0'
        ]);
        ...
        $general->cancel_time = $request->cancel_time;
        $general->payment_timeout = $request->payment_timeout;
        $general->max_gallery_images = $request->max_gallery_images;
        $general->save();
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->organizer_registration = $request->organizer_registration ? Status::ENABLE : Status::DISABLE;
        $general->agree = $request->agree ? Status::ENABLE : Status::DISABLE;
        $general->multi_language = $request->multi_language ? Status::ENABLE : Status::DISABLE;
        $general->event_verification = $request->event_verification ? Status::ENABLE : Status::DISABLE;
        $general->save();
