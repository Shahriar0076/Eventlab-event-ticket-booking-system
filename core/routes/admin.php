...
Route::middleware('admin')->group(function () {
    ...
    // Organizers Manager
    Route::controller('ManageOrganizersController')->name('organizers.')->prefix('organizers')->group(function () {
        Route::get('/', 'allOrganizers')->name('all');
        Route::get('active', 'activeOrganizers')->name('active');
        Route::get('banned', 'bannedOrganizers')->name('banned');
        Route::get('email-verified', 'emailVerifiedOrganizers')->name('email.verified');
        Route::get('email-unverified', 'emailUnverifiedOrganizers')->name('email.unverified');
        Route::get('mobile-unverified', 'mobileUnverifiedOrganizers')->name('mobile.unverified');
        Route::get('kyc-unverified', 'kycUnverifiedOrganizers')->name('kyc.unverified');
        Route::get('kyc-pending', 'kycPendingOrganizers')->name('kyc.pending');
        Route::get('mobile-verified', 'mobileVerifiedOrganizers')->name('mobile.verified');
        Route::get('with-balance', 'organizersWithBalance')->name('with.balance');
    ...
    Route::controller('CategoryController')->name('category.')->prefix('category')->group(function () {
        ...
        Route::post('status/{id}', 'status')->name('status');
        Route::post('sort-table', 'sortCategory')->name('sort');
    });
    ...
    Route::controller('LocationController')->name('location.')->prefix('location')->group(function () {
        ...
        Route::post('featured/{id}', 'featured')->name('featured');
        Route::post('status/{id}', 'status')->name('status');
        Route::post('sort-table', 'sortLocation')->name('sort');
    });
    ...
    Route::controller('EventController')->name('event.')->prefix('event')->group(function () {
        ...
        Route::get('future-events', 'futureEvents')->name('future.events');
        Route::get('running', 'running')->name('running');
        Route::get('expired', 'expired')->name('expired');

        Route::get('/organizer/{id}', 'organizerEvents')->name('organizer');
        Route::post('featured/{id}', 'featured')->name('featured');
    ...
    Route::name('withdraw.')->prefix('withdraw')->group(function () {
        Route::controller('WithdrawalController')->name('data.')->group(function () {
            Route::get('pending/{user_id?}/{type?}', 'pending')->name('pending');
            Route::get('approved/{user_id?}/{type?}', 'approved')->name('approved');
            Route::get('rejected/{user_id?}/{type?}', 'rejected')->name('rejected');
            Route::get('all/{user_id?}/{type?}', 'all')->name('all');
            Route::get('details/{id}', 'details')->name('details');
    ...
    // User Report
    Route::controller('UserReportController')->prefix('report/user')->name('report.user.')->group(function () {
        Route::get('transaction/{userId?}', 'transaction')->name('transaction');
    ...
    // Organizer Report
    Route::controller('OrganizerReportController')->prefix('report/organizer')->name('report.organizer.')->group(function () {
        Route::get('transaction/{organizerId?}', 'transaction')->name('transaction');
        Route::get('login/history', 'loginHistory')->name('login.history');
        Route::get('login/ipHistory/{ip}', 'loginIpHistory')->name('login.ipHistory');
        Route::get('notification/history', 'notificationHistory')->name('notification.history');
        Route::get('email/detail/{id}', 'emailDetails')->name('email.details');
    ...
    Route::controller('KycController')->group(function () {
        ...
        Route::get('kyc-setting-organizer', 'setting')->name('kyc.setting.organizer');
        Route::post('kyc-setting-organizer', 'settingUpdate');
    });
